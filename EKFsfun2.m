function [sys,x0,str,ts,simStateCompliance] = EKFsfun2(t,x,u,flag,delta_t,delta_tc,LiniEKF,TraceS,A1,R1,A2,R2,AR,alpha)
...
bX2=[jX2(1)-A*D*delta_tc*sqrt(jX2(1))+delta_tc*A*alpha*U;delta_tc*B*D*sqrt(jX2(1))+jX2(2)-delta_tc*B*E*sqrt(jX2(2));delta_tc*C*E*sqrt(jX2(2))-delta_tc*C*alpha*U+jX2(3)]; 
AJ=[1-delta_tc*A*D*1/(2*sqrt(jX2(1))) 0 0;
   delta_tc*B*D*1/(2*sqrt(jX2(1)))   1-delta_tc*B*E*1/(2*sqrt(jX2(2))) 0;
   0 delta_tc*C*E/(2*sqrt(jX2(2))) 1];

bP2=AJ*jP2*AJ'+Q;
H=[0 1 0];
Kk2=bP2*H'*(inv(H*bP2*H'+R));
bZ2=bX2(2);  
jX2=bX2+Kk2*(L_M-bZ2)*TraceS(x(4)); 
jP2=bP2-Kk2*H*bP2;
end
x(1)=jX2(1);
