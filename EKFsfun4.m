function [sys,x0,str,ts,simStateCompliance] = EKFsfun4(t,x,u,flag,delta_t,delta_tc,LiniEKF,TraceS,A1,R1,A2,R2,AR,alpha)
...
bX4=[jX4(1)-A*D*delta_tc*sqrt(jX4(1))+delta_tc*A*alpha*U;delta_tc*B*D*sqrt(jX4(1))+jX4(2)-delta_tc*B*E*sqrt(jX4(2));delta_tc*C*E*sqrt(jX4(2))-delta_tc*C*alpha*U+jX4(3)]; 
AJ=[1-delta_tc*A*D*1/(2*sqrt(jX4(1))) 0 0;
   delta_tc*B*D*1/(2*sqrt(jX4(1)))   1-delta_tc*B*E*1/(2*sqrt(jX4(2))) 0;
   0 delta_tc*C*E/(2*sqrt(jX4(2))) 1];

bP4=AJ*jP4*AJ'+Q;
H=[0 1 0];
Kk4=bP4*H'*(inv(H*bP4*H'+R));
bZ4=bX4(2);  
jX4=bX4+Kk4*(L_M-bZ4)*TraceS(x(4)); 
jP4=bP4-Kk4*H*bP4;
end
x(1)=jX4(1);
